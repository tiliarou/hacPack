#ifndef HACPACK_TICKET_FILES_H_
#define HACPACK_TICKET_FILES_H_

#define TICKETCERTSIZE 1792
#define TICKETTIKSIZE 704

const unsigned char ticket_files_cert[TICKETCERTSIZE] = {
...
const unsigned char ticket_files_tik[TICKETTIKSIZE] = {
